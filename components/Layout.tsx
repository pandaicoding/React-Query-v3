        ...
        <footer>
          <Container maxW={{ xl: "1200px" }}>
            <Flex>
              ...
              <Spacer />
              <Box>
                <Link href="https://github.com/pandaicoding" isExternal mx={4}>
                  <Icon as={FaGithub} w={6} h={6} color="#24292e" />
                </Link>
                <Link href="https://www.youtube.com/channel/UC9B1T_ZPYvEYsS7_pol8W7A" isExternal>
                  <Icon as={FaYoutube} w={6} h={6} color="#c4302b" />
                </Link>
                <Code ml={4}>Sumari</Code>
              </Box>
            </Flex>
          </Container>
        </footer>
